    ...
    <section class="ftco-section">
        ...
        ?>
					<div class="col-lg-2 course ftco-animate" style="background-color: steelblue; margin-left: 3px; border-top-left-radius: 5%;" id="im">
						<div class="text pt-4">
							<p class="meta d-flex">
								<span style="color: white;"><i class="icon-user mr-2" style="color: white; background-color: white;"></i></span>
							
							</p>
							<h3><a href="">کۆگای ڕاپەڕین - ڕانیە </a></h3>
							<p><a href="mng_sales.php" class="btn btn-primary">بینینی قائیمەکان </a></p>
						</div>
					</div>
