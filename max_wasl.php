...
?>
 ...
 <div class="container">
    ...
    <tr class="titleTr">
            ...
            <th id="th1" align="center" colspan="6">  <p>  کۆکراوەی قائیمە واسڵکراوەکان    <br>   </p> </th>
        </tr>
    ...
    ?>
        ...
        $sql="SELECT SUM(price),id_koga,id_comp,date FROM sales,companies,stores WHERE state=1 AND id_comp='$id_comp' AND wasl=1 AND sales.id_comp=companies.id AND sales.id_koga=stores.id and type_price='$pricing' GROUP BY id_koga ";
        $res=mysqli_query($conn,$sql);

        while($row=mysqli_fetch_array($res))
        {
        ?>
        <tr style="background-color: darkCyan;  font-size: 15px;" align="center">
        ...
        $sql="SELECT SUM(price),id_koga,id_comp,date FROM sales,companies,stores WHERE state=1 AND id_koga='$id_koga' AND wasl=1 AND sales.id_comp=companies.id AND sales.id_koga=stores.id and type_price='$pricing' GROUP BY id_comp";
        $res=mysqli_query($conn,$sql);
